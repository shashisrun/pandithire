      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Pandit booking service for Hindu puja, havan, wedding rituals, vastu, jyotish, and religious ceremonies.",
            address: { "@type": "PostalAddress", addressLocality: businessInfo.city },
          }),
        }}
      />
