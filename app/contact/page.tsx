...
export const metadata: Metadata = {
  title: "Contact Pandit Hire | Call for Pandit Booking",
  description:
    "Contact Pandit Hire to book a pandit for puja, havan, wedding rituals, Griha Pravesh, Satyanarayan Puja, and other ceremonies.",
};
      ...
      <section className="bg-gradient-to-br from-cream to-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-gray-600 text-lg max-w-2xl mx-auto">
            Have questions or want to book a pandit? Reach out to us directly.
          </p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href={phoneLink}
                      className="text-saffron font-medium hover:text-saffron-dark"
                    >
                      {businessInfo.phone}
                    </a>
                  </div>
