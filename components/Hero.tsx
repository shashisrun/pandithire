      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-maroon-dark leading-tight">
            Hire Experienced Pandits for Puja at Your Home
          </h1>
          <p className="mt-6 text-base sm:text-lg text-gray-600 leading-relaxed">
            Book trusted pandits for Griha Pravesh, Satyanarayan Puja, Wedding
            Rituals, Janam Kundali, Havan, and other Hindu ceremonies.
          </p>
