  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white border-t border-gray-200 shadow-lg">
      <div className="flex">
        <a
          href={phoneLink}
          className="flex-1 flex items-center justify-center gap-2 py-3 bg-saffron text-white font-semibold text-sm"
        >
        ...
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 py-3 bg-green-600 text-white font-semibold text-sm"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
